...
function CreateNewRecipeCard() {
  ...
  return (
    <div onClick={handleOnClick} className=" mx-6 my-10 w-72 aspect-square bg-slate-500 hover:bg-slate-600 hover:cursor-pointer  text-white  text-xl m-6 text-center rounded-lg flex flex-col justify-center items-center">
